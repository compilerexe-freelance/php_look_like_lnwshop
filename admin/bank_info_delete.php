<?php
  ...
  if ($_SESSION['delete_bank'] == 'success') {
    echo '
      <script>
        swal("ลบบัญชีธนาคารเรียบร้อยแล้ว", "", "success")
      </script>
    ';
    $_SESSION['delete_bank'] = null;
  }
?>
              ...
              while ($row = mysqli_fetch_array($result, MYSQL_ASSOC)) {
                echo '
                  <tr>
                    ...
                    <td>'. $row['tel'] .'</td>
                    <td><a href="process/delete_bank.php?id='. $row['id'] .'">ลบ</a></td>
                  </tr>
                ';
              }
