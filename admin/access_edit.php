<?php
  ...
  if ($_SESSION['update_admin'] == 'success') {
    echo '
      <script>
        swal("แก้ไขผู้ดูแลระบบเรียบร้อยแล้ว", "", "success")
      </script>
    ';
    $_SESSION['update_admin'] = null;
  }
?>
...
<div class="row">
  ...
  <div class="col-md-12">
    ...
    <div class="col-md-9" style="margin-top: 20px; background-color: #ffffe6; border: 1px solid #abc; padding-bottom: 160px;">
            ...
            <?php
              ...
              while ($row = mysqli_fetch_array($result, MYSQL_ASSOC)) {
                echo '
                  <tr>
                    <td>'. $row['username'] .'</td>
                    <td><a href="access_edit_form.php?id='. $row['id'] .'">แก้ไข</a></td>
                  </tr>
                ';
              }
