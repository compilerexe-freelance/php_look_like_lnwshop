<?php
  ...
  $sql = "SELECT * FROM tb_infobank WHERE id = $id";
  $result = mysqli_query($conn, $sql);

  while ($row = mysqli_fetch_array($result, MYSQL_ASSOC)) {
    $title_bank   = $row['title_bank'];
    $name         = $row['name'];
    $number_bank  = $row['number_bank'];
    $brach_bank   = $row['brach_bank'];
    $tel          = $row['tel'];
  }
?>
      ...
      <form action="process/update_bank.php" method="post">
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              <td>ชื่อธนาคาร</td>
              <td><input type="text" name="title_bank" id="title_bank" class="form-control" value="<?php echo $title_bank; ?>" required></td>
              <td></td>
            </tr>
            <tr>
              <td>ชื่อบัญชี</td>
              <td><input type="text" name="name" id="name" class="form-control" value="<?php echo $name; ?>" required></td>
              <td></td>
            </tr>
            <tr>
              <td>เลขที่บัญชี</td>
              <td><input type="text" name="number_bank" id="number_bank" class="form-control" value="<?php echo $number_bank; ?>" required></td>
              <td></td>
            </tr>
            <tr>
              <td>สาขา</td>
              <td><input type="text" name="brach_bank" id="brach_bank" class="form-control" value="<?php echo $brach_bank; ?>" required></td>
              <td></td>
            </tr>
            <tr>
              <td>เบอร์</td>
              <td><input type="text" name="tel" id="tel" class="form-control" value="<?php echo $tel; ?>" required></td>
              <td></td>
            </tr>
            <tr>
              <td></td>
